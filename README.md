...
And in the msconfig, write the following on the script/build to specify the destination after decombiling the source files:
```
  "scripts": {
    "build": "babel src -d resource"
    ...
  },
```
...
It converts the code from the src/script.js:
...
To the file in resource/script.js:
```
"use strict";
...
This script now is compatible with the browser specs you've specified in your configuration.

:tada: Congratulations! now you know the purpose of using babel in your code.
